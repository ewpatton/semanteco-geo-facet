SemantEco Geo Module
====================

The SemantEco Geo module adds UI components for selecting geographical
features to constrain dataset queries in SemantEco. This module
complements the semanteco-darrin-facet package.
